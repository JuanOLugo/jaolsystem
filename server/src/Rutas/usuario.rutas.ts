...
import { GetTotalDashboard, InicioSesionUsuario, RegistrarUsuario, UserBasic } from "../middlewares/usuario.m";
...
usuarioRutas.post("/dashboardinfo", PassportStrategy.authenticate("jwt", {session: false}) , GetTotalDashboard)
