...
export function Userinfo({Sales, Usern} : {Sales: Array<IRecentSales> | [], Usern: IUserBasic }) {
  const [recentSales, setrecentSales] = useState<Array<IRecentSales>>(Sales);
